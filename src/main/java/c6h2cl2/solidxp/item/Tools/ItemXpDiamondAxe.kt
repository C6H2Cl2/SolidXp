 ...
 * @author C6H2Cl2
 */
class ItemXpDiamondAxe: ItemAxe(SolidXpRegistry.materialXpDiamond, 8.0f, -3.0f), ICraftResultEnchanted {
    init {
        unlocalizedName = "xpDiamondAxe"
        registryName = ResourceLocation(MOD_ID, "xp_diamond_axe")
